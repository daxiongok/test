...
import com.soubo.db.ShopCartSharedPreferences;
...
public class GoodsDetailApp extends Activity implements OnItemClickListener {
	// 商品图片显示的画廊
	...
	Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				list_price_text.setText("原价：￥" + goods_detail.getMk_price()
						+ "元");
